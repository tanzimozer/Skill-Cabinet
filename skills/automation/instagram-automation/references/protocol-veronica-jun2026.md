# Protocol Veronica — Jun 2026 Execution Log
...
## What it is NOT
- NOT an Instagram scraper repo (no github.com/tanzimozer/protocol-veronica repo)
- NOT a codeword for a feature (it's the full methodology)
- NOT to be created as a standalone tool
...
When reporting Protocol Veronica status: **"city-by-city numbers please"** — means raw counts, not explanation. Report as:
```
...
## Pitfall: Don't create a repo
User asked "create a repo for it" in a misunderstanding. **Protocol Veronica is not a tool to repo** — it's a documented playbook. The playbook lives in SOUL.md and this reference file, not in GitHub. Do not create `tanzimozer/protocol-veronica` repo unless explicitly asked by Tanzim.
